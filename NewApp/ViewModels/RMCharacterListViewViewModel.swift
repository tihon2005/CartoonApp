...
final class RMCharacterListViewViewModel: NSObject {
    ...
    private var characters: [RMCharacter] = []{
        didSet{
            ...
            for character in characters{
                let viewModel = RMCharacterCollectionViewCellViewModel(characterName: character.name, chatacterStatus: character.status, characterImageUrl: URL(string: character.image))
    ...
    public func fetchAdditionalCharacters(url: URL) {
        ...
        RMService.shared.execute(request, expecting: RMGetAllCharactersResponse.self, completion: { [weak self] result in
...
extension RMCharacterListViewViewModel: UIScrollViewDelegate {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        Timer.scheduledTimer(withTimeInterval: 0.2, repeats: false, block: { [weak self] t in
            ...
            if offset >= (totalContentHeight - totalScrollViewFixedHeight + 22) {
